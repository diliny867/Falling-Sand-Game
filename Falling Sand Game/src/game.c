...
//	material_t mat = materials[mat_type];
//
//	int weight = game->gravity * mat.mass;
//	if(weight == 0) {
//		return;
//	}
//	weight += sign(weight);
...
//		new_y = y + direction_y;
//		do {
//			if(materials[grid[GRID_GET_I(x, new_y)]].mass < mat.mass) {
//				can_place = true;
//				if(new_y == target_y) {
//					break;
//				}
...
//			new_x = x + direction_x;
//			do {
//				if(materials[grid[GRID_GET_I(new_x, y)]].mass < mat.mass) {
//					can_place = true;
//					if(new_x == target_x) {
//						break;
//					}
...
//				new_y = y;
//				do {
//					if(materials[grid[GRID_GET_I(new_x, new_y)]].mass < mat.mass) {
//						if(new_y == target_y) {
//							break;
//						}
//						new_y += direction_y;
...
//			if(xorshift32_n(&game->rand_state, mat->mass) > materials[grid[new_index]].mass * materials[grid[new_index]].viscosity){
